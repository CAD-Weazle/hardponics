...
class ChartWindow (QMainWindow):
  def __init__(self):
    ...
    # left part GUI
   #self.layout.addWidget (self.s_plot, 0, 0, 1, 1) # <> org 
...
##################### OBSELETE #####################
   ...
   #self.v_plot.setXRange (0, MAX_LEN, padding=0)
   ...
   #self.v_plot.setDownsampling (ds=None, auto=None, mode="subsample")

  #self.i_plot.setBackground ((44, 44, 44))
  #self.i_plot.setXRange (0, MAX_LEN, padding=0)
  ...
  #self.i_plot.setDownsampling (ds=None, auto=None, mode="subsample")

   #self.t_plot.setBackground ((44, 44, 44))
   #self.t_plot.setXRange (0, MAX_LEN, padding=0)
   ...
   #self.t_plot.setDownsampling (ds=None, auto=None, mode="subsample")
