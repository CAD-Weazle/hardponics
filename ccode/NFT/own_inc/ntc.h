...
// -- defines
#define NTC_NUM_DEVICES                         1  // number of NTC sensors
#define NTC_FILTERDEPTH                        64  // moving average filter depth

#define R_PULL                          (10000.0)  // value NTC pull-up resistor (note: Vpull-up = Vref ADC)
...
// temperature vs resistance table from Murata data sheet
